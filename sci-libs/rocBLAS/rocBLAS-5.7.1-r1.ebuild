...
src_configure() {
	...
	# ROCM_PATH=/usr CXX=hipcc CXX_FLAGS="--rocm-device-lib-path=/usr/lib/amdgcn/bitcode --rocm-path=/usr "
	export LD_LIBRARY_PATH=/opt/rocm/lib:/opt/rocm/rccl/lib:/opt/conda3/lib 
	# HIP_CLANG_PATH=/opt/rocm/llvm/bin CXX=/opt/rocm/hip/bin/hipcc 

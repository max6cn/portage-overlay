...
HOMEPAGE="https://github.com/vitillo/power_gadget"

# Point to any required sources; these will be automatically downloaded by
# Portage.
SRC_URI="https://github.com/vitillo/power_gadget/archive/master.zip"
...
src_compile() {
	...
	emake rapl_lib_static 
	emake power_gadget_static
}
...
src_install() {
	...
	# outside of ${D}.
	# cp ${WORKDIR}/power_gadget-master/power_gadget "${D}"
	dobin power_gadget
}
